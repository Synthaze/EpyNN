...
# Layers
keras_RNN_bis = KRNN(N_CELLS_BIS, kernel_initializer=initializer, return_sequences=True,  activation='tanh')
keras_LSTM = KLSTM(N_CELLS, kernel_initializer=initializer, return_sequences=True, activation='tanh')
keras_flatten = KFlatten()
keras_dense = KDense(OUTPUT_NODES, activation='sigmoid', kernel_initializer=initializer)

# Model
keras_model = Sequential()
keras_model.add(keras_RNN_bis)
...
# Get Params
rnn_bis_weights = keras_model.layers[0].get_weights()
shared_R_bis_U = rnn_bis_weights[0]
shared_R_bis_W = rnn_bis_weights[1]
shared_R_bis_b = rnn_bis_weights[2]


keras_lstm = keras_model.layers[1]
...
shared_W = keras_model.layers[3].get_weights()[0]
shared_b =  keras_model.layers[3].get_weights()[1]
...
epynn_rnn_bis = ERNN(N_CELLS_BIS)
epynn_rnn_bis.p['U'] = shared_R_bis_U
epynn_rnn_bis.p['W'] = shared_R_bis_W
epynn_rnn_bis.p['b'] = shared_R_bis_b
...
epynn_model = EpyNN(layers=[embedding, epynn_rnn_bis, epynn_LSTM, flatten, epynn_dense], settings=settings, seed=SEED)
