...
rnn_bis_weights = keras_model.layers[1].get_weights()
...
epynn_model = EpyNN(layers=[embedding, epynn_rnn, epynn_rnn_bis, flatten, epynn_dense], settings=settings, seed=SEED)
