"""
This will run layers = [input, flatten, output] with output = Dense(2)
...
####### LAYERS ARE FROZEN
keras_model.layers[0].trainable = False # Note this is useless Flatten layer won't be trained anyway
...
epynn_model = EpyNN(layers=[embedding, flatten, epynn_dense], settings=settings, seed=SEED)
