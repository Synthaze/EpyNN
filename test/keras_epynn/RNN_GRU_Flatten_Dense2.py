...
# Layers
keras_RNN_bis = KRNN(N_CELLS_BIS, kernel_initializer=initializer, return_sequences=True, batch_input_shape=(N_SAMPLES, LEN_SEQ, V_SIZE), activation='tanh')
keras_GRU = KGRU(N_CELLS, kernel_initializer=initializer, return_sequences=True, activation='tanh')
...
keras_gru = keras_model.layers[1]
...
epynn_model = EpyNN(layers=[embedding, epynn_rnn_bis, epynn_GRU, flatten, epynn_dense], settings=settings, seed=SEED)
