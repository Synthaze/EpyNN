...
dense = Dense(100,cm.relu) # Custom (num_neurons=16,activate=cm.relu)
out_dense = Dense(10,cm.softmax) # Custom (num_neurons=10,activate=cm.softmax)
...
layers = [conv,pooling,flatten,dense,out_dense]
########################################################################
