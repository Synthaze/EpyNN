...
class Template(Layer):
    ...
    def compute_shapes(self, A):
        """Is a wrapper for :func:`nnlibs.template.parameters.template_compute_shapes()`.
    ...
    def initialize_parameters(self):
        """Is a wrapper for :func:`nnlibs.template.parameters.template_initialize_parameters()`.
        """
    ...
    def forward(self, A):
        """Is a wrapper for :func:`nnlibs.template.forward.template_forward()`.
    ...
    def compute_gradients(self):
        """Is a wrapper for :func:`nnlibs.template.parameters.template_compute_gradients()`. Dummy method, there are no gradients to compute in layer.
        """
    ...
    def update_parameters(self):
        """Is a wrapper for :func:`nnlibs.template.parameters.template_update_parameters()`. Dummy method, there are no parameters to update in layer.
        """
        if self.trainable:
